...
## Call the config file for data ingestion 
# configuration for data ingestion config

from networksecurity.entity.config_entity import DataIngestionConfig
from networksecurity.entity.artifact_entity import DataIngestionArtifact

## importing all necessary for my data ingestion 
import sys ,os
import pymongo
import pandas as pd
import numpy as np
...
class DataIngestion:
    def __init__(self,data_ingestion_config:DataIngestionConfig):
        try:
            ## here we need to initislize entire data ingestion config from this dataingestionconfig class
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info(f"exporting traing file path")
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            a=self.split_data_as_train_test(dataframe)
