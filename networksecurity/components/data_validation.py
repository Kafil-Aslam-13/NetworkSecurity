...
## for data drift we are going to use a library from scipy 
from scipy.stats import ks_2samp ## ks will check 2 samples of data to find out whether there is data drift or not 
import os,sys
import pandas as pd
